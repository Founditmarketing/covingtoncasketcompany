    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-8 lg:px-4 text-center text-white">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          <button className="btn-swipe flex items-center justify-center bg-[#d21243] text-white [--btn-swipe:#152239] font-sans font-bold px-8 py-4 uppercase tracking-widest text-xs rounded-sm w-full sm:w-auto shadow-[0_0_20px_rgba(210,18,67,0.4)]">
          ...
          <button className="btn-swipe bg-[#152239] border border-[#b1a17c] text-white [--btn-swipe:#d21243] font-sans font-bold px-8 py-4 uppercase tracking-widest text-xs rounded-sm w-full sm:w-auto">
